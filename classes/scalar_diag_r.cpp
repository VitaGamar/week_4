...
//Задана квадратна матриця розмірності m × m. Матрицю задати в класі Matr. Знайти скалярний добуток  
//головної діагоналі на  перший рядок матриці. Розмірність задати в головній програмі константою.
//Елементами матриці є цілі числа.
